        ...
        <ul class="slides-container">
            @foreach ($sliders as $slider)
                <li class="text-center">
                    <img src="{{asset("storage/sliderImage/$slider->image")}}" alt="">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20">{{$slider->description1}}</h1>
                    ...
                    <div class="col-lg-3 col-md-6 special-grid best-seller">
                        <div class="products-single fix">
                            <div class="box-img-hover">
                                ...
                                <img src="{{asset("/storage/productImage/$product->product_image")}}" class="img-fluid" alt="Image">
                                <div class="mask-icon">
                                    <ul>
